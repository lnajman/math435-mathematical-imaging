...
Wavelets also complete a short representation ladder:

| Representation | Main idea | Limitation |
|---|---|---|
| pixels | direct spatial samples | weak at separating structure from noise |
| Fourier | global orthogonal frequencies | no spatial localization |
| DCT/sparse transforms | compact coefficient descriptions | representation still fixed by hand |
| wavelets | localized multiscale features | filters are designed, not learned |

Chapter 12 asks what happens when the last row becomes learnable. Neural features are not introduced as magic; they are introduced after students have seen why representation choice matters.
