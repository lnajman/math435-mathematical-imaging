...
The reliability questions in this chapter apply to every method in the course. Tikhonov can over-smooth. TV can create artificial plateaus. Sparse and wavelet methods can erase texture. Learned priors can hallucinate or fail under distribution shift. The mechanisms differ, but the responsibility is the same: report what was measured, what was assumed, and what evidence supports the claim.
...
The chapters can also be read as a sequence of roles:

| Course role | Where it appears |
|---|---|
| define the unknown and measurement | images, masks, blur, Fourier analysis |
| understand uncertainty and instability | noise, likelihoods, ill-posedness |
| choose explicit prior information | Tikhonov, TV, sparsity, wavelets |
| compute the reconstruction | gradient, proximal, and iterative methods |
| learn prior information | data-driven priors, denoisers, unrolled updates |
| justify trust | residuals, robustness, failures, and documentation |
