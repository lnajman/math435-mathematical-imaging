...
| Session | Focus |
|---|---|
| Session 1 | Energy viewpoint; data term and regularizer; convexity; Euler-Lagrange equation. |
| Session 2 | Gradient descent intuition; quadratic denoising; real-image limits. |

## Session 1: Energies as Models {.section-slide}

::: {.section-kicker}
Data agreement plus image structure
:::
...
::: {.figure-frame}
![](../assets/figures/week07-euler-lagrange-stencil.png){fig-alt="Finite-difference neighborhood and Euler-Lagrange equations for quadratic smoothing" height=300}
:::
...
## Session 2: From Optimality to Algorithms {.section-slide}

::: {.section-kicker}
Minimizers have to be computed
:::
