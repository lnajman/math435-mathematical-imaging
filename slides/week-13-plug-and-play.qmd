...
| 38-52 min | learned regularization and examples |
| 52-62 min | convergence, fixed points, and failure modes |
...
## Code Demo: Run Week 13 Examples {.code-small}

From the repository root:

```bash
python3 examples/week13_plug_and_play.py
python3 examples/make_week13_figures.py
...
|---|---|
| proximal operator | balances closeness to input and regularization |
| PnP replacement | replaces prox with a denoiser |
| no known objective | denoiser may not equal any prox |
| fixed point | an iterate unchanged by the update rule |
...
Course project workshop and imaging case studies:

- choosing a forward model;
- choosing a regularizer or learned prior;
