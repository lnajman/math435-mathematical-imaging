...
| Session | Focus |
|---|---|
| Session 1 | Proximal algorithms; denoising interpretation; plug-and-play update. |
| Session 2 | Learned regularization; deblurring example; fixed points, convergence, and trust. |

## Session 1: Plugging a Denoiser into an Inverse Problem {.section-slide}

::: {.section-kicker}
Data consistency plus denoising
:::
...
## Session 2: Learned Regularization and Trust {.section-slide}

::: {.section-kicker}
Useful does not automatically mean justified
:::
...
- Use Chapter 13 of the book for the proximal-to-denoiser bridge.
