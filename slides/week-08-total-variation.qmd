...
| Session | Focus |
|---|---|
| Session 1 | TV definition; sparse gradients; l2 versus TV; one-dimensional edge preservation. |
| Session 2 | Image denoising; parameter effects; staircasing; modeling limits. |

## Session 1: Edges as Structure {.section-slide}

::: {.section-kicker}
Not every large gradient is an error
:::
...
## Session 2: Images, Artifacts, and Limits {.section-slide}

::: {.section-kicker}
Edge preservation is a modeling choice
:::
...
The syllabus also places the midterm around this part of the course.
