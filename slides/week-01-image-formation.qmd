...
| Session | Focus |
|---|---|
| Session 1 | Course pattern; images as functions, arrays, vectors; pixel grids and NumPy representation. |
| Session 2 | Forward models; masking and occlusion; missing information; assumptions. |

## Session 1: Images as Data {.section-slide}
...
## Session 2: Forward Models and Missing Information {.section-slide}

::: {.section-kicker}
What the data did and did not record
:::
...
A fixed kernel combines neighboring pixels with fixed weights. This is a linear forward model. Read Chapter 2's convolution preview alongside Chapter 1.
:::
:::
...
Convolution, blur, and a first Fourier view:

- 1D and 2D convolution;
- point spread functions;
- boundary conditions;
- blur as a linear operator;
- frequency interpretation and a first deblurring experiment.
