...
## Code Demo: Run Week 10 Examples {.code-small}

From the repository root:

```bash
python3 examples/week10_sparse_reconstruction.py
python3 examples/make_week10_figures.py
...
|---|---|
| sparse | few nonzero or significant coefficients |
| l1 zeros | corners and soft thresholding |
| l2 failure | spreads energy across many coefficients |
| image sparsity | a representation or transform |
