...
| Session | Focus |
|---|---|
| Session 1 | Sparsity; representation choice; l1 versus l2; underdetermined recovery. |
| Session 2 | Compressed sensing intuition; sparse images; DCT priors; notebook evidence. |

## Session 1: Sparsity as a Prior {.section-slide}

::: {.section-kicker}
Few important coefficients, if the representation fits
:::
...
## Session 2: From Sparse Vectors to Sparse Images {.section-slide}

::: {.section-kicker}
The prior only helps when the representation matches
:::
...
- Use Chapter 10 of the book to connect l1 geometry with representation-dependent priors.
