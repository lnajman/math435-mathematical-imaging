...
- Learn a small patch prior from image data.
...
| 8-22 min | model-based imaging pipeline |
| 22-36 min | data-driven imaging pipeline |
| 36-48 min | neural networks as operators |
| 48-60 min | learned patch prior example |
...
## Code Demo: Run Week 12 Examples {.code-small}

From the repository root:

```bash
python3 examples/week12_model_data.py
python3 examples/make_week12_figures.py
...
1. Change the number of learned PCA components.
2. Change the noise level.
3. Change the training crop.
4. Compare Gaussian, wavelet, and learned patch priors.
5. Test on a different image.
:::
...
2. What does a data-driven method learn?
3. Why is a neural network an operator?
...
- iterative algorithms with learned denoisers;
- replacing proximal operators;
- learned priors inside optimization loops;
