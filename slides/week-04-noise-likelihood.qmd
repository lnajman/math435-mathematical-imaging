...
- Leave the final 20 minutes for Quiz 1.
:::

## Two-Session Plan + Quiz 1

| Session | Focus |
|---|---|
| Session 1 | Observation models; Gaussian noise; Poisson photon-counting noise. |
| Session 2 | Likelihoods as data terms; repetition limits; reconstruction view; Quiz 1 in the final 20 minutes. |

## Session 1: Noise as a Measurement Model {.section-slide}

::: {.section-kicker}
What kind of uncertainty did the sensor create?
:::
...
::: {.question-box}
We discussed why deblurring amplifies noise. This week: what is that noise?
:::
...
## Session 2: Likelihoods and Quiz 1 {.section-slide}

::: {.section-kicker}
From noise model to data term
:::
...
## Part 4: What Repetition Can Fix {.section-slide}

::: {.section-kicker}
Noise can average out, missing information cannot
:::
...
::: {.takeaway-box}
Independent random noise decreases like $1/\sqrt{m}$ when we average repeated measurements.
:::

## Averaging Picture and Limit

::: {.figure-frame}
![](../assets/figures/week04-averaging.png){fig-alt="Clean image and averages of 1, 2, 4, and 16 Gaussian noisy observations" height=260}
:::

::: {.question-box}
Hidden behind a tree: can averaging reveal what never reached the sensor?
:::

::: {.takeaway-box}
Averaging reduces random noise. It cannot recover unobserved scene content.
:::
...
::: {.exercise-box}
Use the same questions we used all morning:

1. What was measured?
2. What uncertainty model is assumed?
3. What data term follows from that assumption?
4. What information is still missing from the data?
:::
...
- Run the corresponding notebook and change Gaussian `sigma` or Poisson `peak_photons`.
