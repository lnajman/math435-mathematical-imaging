...
- Interpret blur and inverse instability in Fourier coordinates.
:::
...
| Session | Focus |
|---|---|
| Session 1 | 1D and 2D convolution; kernels; point spread functions; real image blur. |
| Session 2 | Boundaries; matrix view; Fourier transform and convolution theorem; deblurring. |

## Session 1: Blur as a Forward Model {.section-slide}

::: {.section-kicker}
Local averages become operators
:::
...
This week, $A$ will be a blur operator.
:::
...
## Run This Week's Code {.code-small}
...
## Session 2: Fourier View and Deblurring {.section-slide}

::: {.section-kicker}
The model choices become visible at the edges
:::
...
## A First Fourier View

The Fourier transform describes a signal by its oscillating components:

$$
\widehat{x}(\xi)=\int_{\mathbb R}x(t)e^{-2\pi i\xi t}\,dt.
$$

::: {.checklist}
- Low frequencies describe slow variation; high frequencies describe rapid variation.
- Each coefficient compares the signal with a global oscillation.
- Week 3 develops the discrete transform and its computation by FFT.
:::

## Convolution Becomes Multiplication

For convolution, the Fourier transform gives
...
::: {.checklist}
- For typical smoothing kernels, high-frequency components are attenuated.
- Dividing by a small $\widehat h$ amplifies noise; zeros lose information.
- Finite arrays use this product rule with circular convolution or suitable padding.
:::
...
::: {.caption}
Week 3 develops the DFT, spectral plots, and frequency-domain filtering.
:::
...
4. How does $\widehat y=\widehat h\,\widehat x+\widehat\eta$ explain noise amplification?
:::
