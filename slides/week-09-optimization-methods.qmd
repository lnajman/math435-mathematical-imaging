...
| Session | Focus |
|---|---|
| Session 1 | Convexity; smooth optimization; gradient descent; step-size diagnostics. |
| Session 2 | Nonsmooth terms; proximal operators; ISTA; convergence evidence. |

## Session 1: Smooth Optimization {.section-slide}

::: {.section-kicker}
Follow a descent direction
:::
...
## Session 2: Nonsmooth Priors and Proximal Steps {.section-slide}

::: {.section-kicker}
Sparse models need a different move
:::
...
::: {.figure-frame}
![](../assets/figures/week09-soft-threshold.png){fig-alt="Absolute value nonsmoothness and soft-thresholding proximal operator" height=315}
:::
